...
function Footer() {
  return (
  <footer className="bg-[#fff] relative z-10 bg-white pt-20 pr-10 pb-10 lg:pt-[120px] lg:pb-20">
      ...
      <div className="-mx-4 flex flex-wrap">
        <div className="w-full px-4 sm:w-2/3 lg:w-4/12">
          <div className="mb-10 w-full">
            ...
            <p className="text-body-color mb-7 text-base text-justify lg:w-11/12">
            Out of the Shadows (OOTS) is organized as a nonprofit corporation operating under section 501(c)(3); 
            therefore, OOTS is exempt from federal and state income taxes; 
            however to the extent OOTS incurs unrelated business income this form of income would be taxable to OOTS.
            </p>
        ...
        <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div className="mb-10 w-full">
            ...
            <p className="text-body-color text-base">&copy; 2023 Out of the Shadows (OOTS) is a 501c3 foundation</p>
          </div>
        </div>
      </div>
    </div>
